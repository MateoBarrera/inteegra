!(function (e, t) {
				...
				(function (e, t, n, o) {
					...
					C([e, t, n], p.styled),
						o.confirmButtonColor &&
							((e.style.backgroundColor = o.confirmButtonColor), C(e, p["default-outline"]))
					o.denyButtonColor &&
						((t.style.backgroundColor = o.denyButtonColor), C(t, p["default-outline"]))
					o.cancelButtonColor &&
						((n.style.backgroundColor = o.cancelButtonColor), C(n, p["default-outline"]))
				})(i, a, r, o),
				o.reverseButtons &&
					(o.toast
	...
	const Ie = (e, t) => {
		...
		i &&
			...
			"string" == typeof (n = t.backdrop)
				...
				: n || C([document.documentElement, document.body], p["no-backdrop"]),
			(o = i),
			(n = t.position) in p
				? C(o, p[n])
				: (a('The "position" parameter is not valid, defaulting to "center"'), C(o, p.center)),
			(n = i),
			(o = t.grow) && "string" == typeof o && (o = "grow-".concat(o)) in p && C(n, p[o]),
			w(i, t, "container"))
	}
	var L = {
	...
	const De = ["input", "file", "range", "select", "radio", "checkbox", "textarea"],
		He = (e, r) => {
			...
			De.forEach((e) => {
				...
				r.input &&
					...
					(e = r),
					(t = Re(e.input)),
					"object" == typeof e.customClass && C(t, e.customClass.input))
		},
		qe = (t) => {
		...
		Ne = (e, t, n) => {
			if (n.inputLabel) {
				...
				i.setAttribute("for", e.id),
					(i.className = o),
					"object" == typeof n.customClass && C(i, n.customClass.inputLabel),
		...
		Fe =
			((O.text =
				...
				O.tel =
				O.url =
					(e, t) => (Ue(e, t.inputValue), Ne(e, e, t), Ve(e, t), (e.type = t.input), e)),
		...
		Xe = (e, t) => {
			...
			;(e.textContent = ""),
				t.iconHtml
					...
					: "error" === t.icon
					? y(e, Je)
					: ((n = { question: "?", warning: "!", info: "i" }), y(e, Qe(n[t.icon])))
		},
		$e = (e, t) => {
			if (t.iconColor) {
		...
		et = (e, n) => {
			...
			B(o),
				...
				n.progressSteps.forEach((e, t) => {
					...
					o.appendChild(e),
						t === n.currentProgressStep && C(e, p["active-progress-step"]),
						t !== n.progressSteps.length - 1 &&
							((e = ((e) => {
								const t = document.createElement("li")
								if ((C(t, p["progress-step-line"]), e.progressStepsDistance))
		...
		nt = (e, t) => {
			...
			const o = g()
			t.toast
				? (P(n, "width", t.width), (o.style.width = "100%"), o.insertBefore(d(), s()))
				: P(o, "width", t.width),
				...
				x(ee())
			n = o
			;((n.className = "".concat(p.popup, " ").concat(E(n) ? t.showClass.popup : "")), t.toast)
				? (C([document.documentElement, document.body], p["toast-shown"]), C(n, p.toast))
				: C(n, p.modal)
	...
	const bt = () => {
		...
		yt = () => {
			null !== c.previousBodyPadding &&
				((document.body.style.paddingRight = "".concat(c.previousBodyPadding, "px")),
		...
		xt = (e, t, n) => {
			C(e, n.showClass.backdrop),
				...
				n.heightAuto &&
					n.backdrop &&
					!n.toast &&
					C([document.documentElement, document.body], p["height-auto"])
		},
		I = (e) => {
			let t = g()
			t || new An(), (t = g())
				...
				if ((o.stopKeydownPropagation && n.stopPropagation(), "Enter" === n.key))
					(e = e),
						...
						R(i.allowEnterKey) &&
							...
							(["textarea", "file"].includes(i.input) || (It(), s.preventDefault()))
				else if ("Tab" === n.key) {
					e = n
					var i = o
					var a = e.target,
			...
			"function" == typeof n.willClose && n.willClose(t),
				s
					? ((s = e),
					  ...
					  (i = n.returnFocus),
					  (a = n.didClose),
					  (T.swalCloseEventFinishedCallback = Rt.bind(null, s, t, i, a)),
					  o.addEventListener(Oe, function (e) {
							e.target === o &&
								(T.swalCloseEventFinishedCallback(), delete T.swalCloseEventFinishedCallback)
					  }))
		...
		_destroy: function () {
			...
			t
				? (e.popup &&
						...
						(T.swalCloseEventFinishedCallback(), delete T.swalCloseEventFinishedCallback),
				  T.deferDisposalTimer && (clearTimeout(T.deferDisposalTimer), delete T.deferDisposalTimer),
	...
	const Jt = (e, t) => {
			...
			if (n.inputValidator) {
				...
				c.then((e) => {
					i.enableButtons(),
						i.enableInput(),
						e ? i.showValidationMessage(e) : ("deny" === r ? Xt : Gt)(i, a)
				})
			} else
	...
	class D {
		...
		_main(e) {
			var t = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {},
				e =
					(J(Object.assign({}, t, e)),
					T.currentInstance && (T.currentInstance._destroy(), re() && at()),
	...
	const hn = (l, u, d) =>
			new Promise((e, t) => {
				...
				Mt.swalPromiseResolve.set(l, e),
					...
					(t = u),
					(a = n),
					L.innerParams.get(e).toast ? en(e, t, a) : (nn(t), on(t), an(e, t, a)),
					(o = l),
					(e = T),
					(t = d),
					(i = n),
						  ...
						  (I(h()), Tt(a, t))
				{
					...
					"function" == typeof r.willOpen && r.willOpen(c),
						...
						se() || T.previousActiveElement || (T.previousActiveElement = document.activeElement),
		...
		wn = (e, t) =>
			t.focusDeny && E(e.denyButton)
				...
				: !(!t.focusConfirm || !E(e.confirmButton)) && (e.confirmButton.focus(), !0),
		Cn = () => {
