...
!(function (a, b) {
	...
	return (
		(function (a, b) {
			...
			;(b.namespaces = {
				...
				(b.createLabel = function (a, c, e, f, g, h, i, j, k, l, m) {
					...
					m.emit(
						"draw",
						b.extend({ type: "label", axis: g, index: e, group: j, element: n, text: f[e] }, o)
					)
				}),
								...
								j
									? l
										? m - 4 === l
											? (n[3] = { x: +c[0], y: +c[1] })
											: m - 2 === l &&
											  ((n[2] = { x: +c[0], y: +c[1] }), (n[3] = { x: +c[2], y: +c[3] }))
										: (n[0] = { x: +c[m - 2], y: +c[m - 1] })
									: m - 4 === l
									? (n[3] = n[2])
									: l || (n[0] = { x: +c[l], y: +c[l + 1] }),
						...
						function (e) {
							function f(a, c) {
								var f,
									...
									i = {}
								a.easing &&
									((h = a.easing instanceof Array ? a.easing : b.Svg.Easing[a.easing]),
									delete a.easing),
		...
		(function (a, b) {
			...
			function d(a) {
				return (
					(this.axisLength * (+b.getMultiValue(a, this.units.pos) - this.bounds.min)) /
					this.bounds.range
				)
			}
			a.window, a.document
		...
		(function (a, b) {
			...
			function d(a) {
				return (
					(this.axisLength * (+b.getMultiValue(a, this.units.pos) - this.range.min)) /
			...
			function c(a) {
				...
				;(d =
					...
					a.showGridBackground &&
						b.createGridBackground(g, j, a.classNames.gridBackground, this.eventEmitter),
		...
		(function (a, b) {
			...
			function c(a) {
				...
				l.createGridAndLabels(f, h, this.supportsForeignObject, a, this.eventEmitter),
					...
					a.showGridBackground &&
						b.createGridBackground(f, o, a.classNames.gridBackground, this.eventEmitter),
					c.raw.series.forEach(
						function (d, e) {
							var f,
								h,
								...
								if (
									...
									if (B || 0 === B) {
										var C = d
											.elem(
												"text",
												{ dx: z.x, dy: z.y, "text-anchor": c(n, z, a.labelDirection) },
												a.classNames.label
											)
											.text("" + B)
										this.eventEmitter.emit("draw", {
