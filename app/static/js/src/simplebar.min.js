...
!(function (t, e) {
	...
	var Qt =
		...
		re =
			...
			function (t, e) {
				...
				return (
					null !== t
						? ((te.prototype = R(t)), (r = new te()), (te.prototype = null), (r[Zt] = t))
						: (r = ee()),
					void 0 === e ? r : Kt(r, e)
				)
			}
	...
	var oe,
		...
		ve = !1
	;[].keys &&
		("next" in (ae = [].keys()) ? (se = de(de(ae))) !== Object.prototype && (oe = se) : (ve = !0)),
		null == oe && (oe = {}),
		S(oe, pe) ||
			C(oe, pe, function () {
				return this
		...
		Te = function (t, e, r, i, n, o, s) {
			...
			if (
				(b &&
					...
					Se !== Object.prototype &&
						a.next &&
						(de(a) !== Se && (we ? we(a, Se) : "function" != typeof a[ke] && C(a, ke, Ae)),
						me(a, f, !0))),
				"values" == n &&
					v &&
					"values" !== v.name &&
	...
	var hr = function (t, e, r, i, n) {
			...
			return (
				(f[t] = l), At({ global: !0, forced: l != o }, f), me(l, t), n || r.setStrong(l, t, i), l
			)
		},
		dr = er.getWeakData,
		pr = K.set,
